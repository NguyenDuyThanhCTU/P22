...
const Section2 = () => {
  return (
    <div className="bg-[rgb(63,63,255)] py-20">
      <div className="w-[1000px] mx-auto text-white flex flex-col justify-center gap-5 items-center">
        ...
        <div className="grid grid-cols-3 gap-8">
          <div className="">
            <div className="relative">
              <img
                ...
                alt="section2"
                className="rounded-tl-[100px]  h-[240px] w-full"
              />
          ...
          <div>
            ...
            <div className="bg-[rgb(0,25,158)] text-white py-5">
              <div className="p-6 text-center">
          ...
          <div>
            <div className="relative">
              <img
                ...
                alt="section2"
                className="rounded-tr-[100px] h-[240px] w-full"
              />
              <div className="-bottom-8 right-1 left-1 absolute w-full flex justify-center">
                <div className=" text-[50px] p-2 rounded-full  text-[rgb(3,237,166)] bg-white shadow-2xl">
                  <PiDiamondsFourFill />
